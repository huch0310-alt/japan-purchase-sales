      ...
      <el-col :span="16">
        <el-card>
          <el-descriptions
            ...
            border
          >
            <el-descriptions-item :label="t('product.title')">
              {{ product.name }}
            </el-descriptions-item>
            <el-descriptions-item :label="t('product.category')">
              {{ product.category?.name || '-' }}
            </el-descriptions-item>
            <el-descriptions-item :label="t('product.inventory')">
              {{ product.quantity }} {{ product.unit }}
            </el-descriptions-item>
            <el-descriptions-item :label="t('product.purchasePrice')">
              {{ formatCurrency(product.purchasePrice) }}
            </el-descriptions-item>
            <el-descriptions-item :label="t('product.salePrice')">
            ...
            <el-descriptions-item :label="t('product.description')">
              {{ product.description || '-' }}
            </el-descriptions-item>
